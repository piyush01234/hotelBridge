package com.piyush.hotelBridge.controller;
...
import com.piyush.hotelBridge.service.HotelService;
import com.piyush.hotelBridge.service.InventoryService;
...
public class HotelBrowseController {
    ...
    public ResponseEntity<Page<HotelPriceResponseDto>> searchHotels(@ModelAttribute HotelSearchRequest hotelSearchRequest) {
    ...
    public ResponseEntity<HotelInfoDto> getHotelInfo(@PathVariable Long hotelId, @ModelAttribute HotelInfoRequestDto hotelInfoRequestDto) {
